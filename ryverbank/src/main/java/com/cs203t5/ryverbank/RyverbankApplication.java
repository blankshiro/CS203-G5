...
public class RyverbankApplication {
	public static void main(String[] args) {
		...
		// AccountRepository account = ctx.getBean(AccountRepository.class);
		// System.out.println("[Add account]: "+ account.save(
		// 	new Account(1L, 5000.00, 15000.00)).getCustomer_id());

		// System.out.println("[Add account]: "+ account.save(
		// 	new Account(1L, 4000.00, 15000.00)).getCustomer_id());

		// System.out.println("[Add account]: "+ account.save(
		// 	new Account(2L, 1000.00, 15000.00)).getCustomer_id());
